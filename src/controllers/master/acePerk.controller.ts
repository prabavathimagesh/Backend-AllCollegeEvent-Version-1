...
export class AcePerkController {
  static create = async (req: Request, res: Response) =>
    res.json({ success: true, data: await AcePerkService.create(req.body.perkName) });

  static getAll = async (_: Request, res: Response) =>
    res.json({ success: true, data: await AcePerkService.getAll() });

  static getOne = async (req: Request, res: Response) =>
    res.json({ success: true, data: await AcePerkService.getById(req.params.id) });
