 ...
 */
router.post("/organizations/:orgId/events", authMiddleware_1.authMiddleware, (0, validate_1.validate)(event_validation_1.eventValidation.create), fileUpload_1.default.single("image"), event_controller_1.EventController.createEvent);
/**
